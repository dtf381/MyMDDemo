...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.drawable.snow_flake1);
        Drawable yellow = getResources().getDrawable(R.drawable.snow_flake1);
        Drawable blue = getResources().getDrawable(R.drawable.snow_flake1);
