package com.sunjiajia.alldemo.blur;
...
public class BlurMainActivity extends Activity {

	private static final String BLURRED_IMG_PATH = "blurred_imageaa.png";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!blurredImage.exists()) {
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					Bitmap newImg = Blur.fastblur(BlurMainActivity.this, image, 12);
		...
		mList.setAdapter(new ArrayAdapter<String>(this, R.layout.blurlist_item, strings));
