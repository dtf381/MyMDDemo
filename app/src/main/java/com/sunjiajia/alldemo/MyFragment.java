...
import com.sunjiajia.alldemo.adapter.MyRecyclerViewAdapter;
import com.sunjiajia.alldemo.adapter.MyStaggeredViewAdapter;
import com.sunjiajia.alldemo.utils.SnackbarUtil;
...
public class MyFragment extends Fragment
  ...
  @Override public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    // 刷新时，指示器旋转后变化的颜色
    mSwipeRefreshLayout.setColorSchemeResources(R.color.main_black_grey,R.color.cardview_light_background);
