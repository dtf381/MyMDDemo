...
public class PullToRefreshView extends LinearLayout {
    ...
    /**
     * pullToRefresh status,values controller status.default status is all.
     * */
    public int modeStatus = 0;
    /**
     * three mode*/
    public int modeAllPullToRefresh = 0;
    public int modeHeadrRefresh = 1;
    public int modeFooterLoad =2;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                switch (modeStatus){
                    ...
                    case 1://modeHeadrRefresh
                        ...
                        mLastMotionY = y;
                        break;
                    case 2://modeFooterLoad
                         if (mPullState == PULL_UP_STATE) {// 执行上拉
                            footerPrepareToRefresh(deltaY);
                        }
                        mLastMotionY = y;
                        break;
