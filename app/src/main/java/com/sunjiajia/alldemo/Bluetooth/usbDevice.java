...
/**
 * Created by mk on 2017/1/4.
 */

public class usbDevice extends Activity implements View.OnClickListener {
    //设备列表
...
//        result_tv.setText(String.valueOf(ret));
    ...
    private void showTmsg(String msg) {
        Toast.makeText(usbDevice.this, msg, Toast.LENGTH_SHORT).show();
    }*/
}
